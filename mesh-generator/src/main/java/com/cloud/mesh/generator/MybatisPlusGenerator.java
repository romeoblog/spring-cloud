 ...
 */
package com.cloud.mesh.generator;
...
//        strategy.setInclude(new String[] { "tb_permission", "tb_role", "tb_role_permission", "tb_user", "tb_user_role"});
        ...
        strategy.setSuperMapperClass("com.cloud.mesh.base.SuperMapper");
        strategy.setSuperEntityClass("com.cloud.mesh.base.SuperEntity");
        //strategy.setSuperServiceImplClass("com.cc.platform.base.SuperServiceImpl");
        mpg.setStrategy(strategy);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.cloud.mesh");
...
//        mpg.setCfg(cfg);
    ...
    public static void main(String[] args) {
        ...
        MybatisPlusGenerator.generate(dataSourceConfig, "/Users/zhengweilu/Documents/projects/private/spring-cloud/mesh-entity", "");
