 ...
 */
package com.dg.mall.gateway.configuration;
...
public class SwaggerProvider implements SwaggerResourcesProvider {
    ...
    // RouteDefinition{id='CompositeDiscoveryClient_DG-MALL-ORDER-SERVICE', predicates=[PredicateDefinition{name='Path', args={pattern=/DG-MALL-ORDER-SERVICE/**}}], filters=[FilterDefinition{name='RewritePath', args={regexp=/DG-MALL-ORDER-SERVICE/(?<remaining>.*), replacement=/${remaining}}}], uri=lb://DG-MALL-ORDER-SERVICE, order=0}
    // RouteDefinition{id='CompositeDiscoveryClient_DG-MALL-CLOUD-GATEWAY', predicates=[PredicateDefinition{name='Path', args={pattern=/DG-MALL-CLOUD-GATEWAY/**}}], filters=[FilterDefinition{name='RewritePath', args={regexp=/DG-MALL-CLOUD-GATEWAY/(?<remaining>.*), replacement=/${remaining}}}], uri=lb://DG-MALL-CLOUD-GATEWAY, order=0}
    // RouteDefinition{id='CompositeDiscoveryClient_DG-MALL-EUREKA-EUREKA', predicates=[PredicateDefinition{name='Path', args={pattern=/DG-MALL-EUREKA-EUREKA/**}}], filters=[FilterDefinition{name='RewritePath', args={regexp=/DG-MALL-EUREKA-EUREKA/(?<remaining>.*), replacement=/${remaining}}}], uri=lb://DG-MALL-EUREKA-EUREKA, order=0}
    ...
    // RouteDefinition{id='dg-mall-order-service', predicates=[PredicateDefinition{name='Path', args={_genkey_0=/order/**}}], filters=[], uri=lb://dg-mall-order-service, order=0}
