 ...
 */
package com.dg.mall.service.order.configuration;
...
public class SwaggerDocumentationConfig {
    ...
    public Docket customImplementation() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.dg.mall.service.order"))
                .apis(RequestHandlerSelectors.basePackage("com.dg.mall.service.order.controller")).build()
                .apiInfo(apiInfo());
    }
