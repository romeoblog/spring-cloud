 ...
 */
package com.dg.mall.service.storage.configuration;
...
public class SwaggerDocumentationConfig {
    ...
    public Docket customImplementation() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.dg.mall.service.storage"))
                .apis(RequestHandlerSelectors.basePackage("com.dg.mall.service.storage.controller")).build()
                .apiInfo(apiInfo());
    }
