...
public class SwaggerProvider implements SwaggerResourcesProvider {
    ...
    // RouteDefinition{id='CompositeDiscoveryClient_DG-MALL-ORDER-SERVICE', predicates=[PredicateDefinition{name='Path', args={pattern=/EXAMPLE-ORDER-SERVICE/**}}], filters=[FilterDefinition{name='RewritePath', args={regexp=/EXAMPLE-ORDER-SERVICE/(?<remaining>.*), replacement=/${remaining}}}], uri=lb://EXAMPLE-ORDER-SERVICE, order=0}
    // RouteDefinition{id='CompositeDiscoveryClient_DG-MALL-CLOUD-GATEWAY', predicates=[PredicateDefinition{name='Path', args={pattern=/EXAMPLE-GATEWAY/**}}], filters=[FilterDefinition{name='RewritePath', args={regexp=/EXAMPLE-CLOUD-GATEWAY/(?<remaining>.*), replacement=/${remaining}}}], uri=lb://EXAMPLE-GATEWAY, order=0}
    // RouteDefinition{id='CompositeDiscoveryClient_DG-MALL-EUREKA-EUREKA', predicates=[PredicateDefinition{name='Path', args={pattern=/EXAMPLE-EUREKA-EUREKA/**}}], filters=[FilterDefinition{name='RewritePath', args={regexp=/EXAMPLE-EUREKA-EUREKA/(?<remaining>.*), replacement=/${remaining}}}], uri=lb://EXAMPLE-EUREKA, order=0}
    ...
    // RouteDefinition{id='example-order-service', predicates=[PredicateDefinition{name='Path', args={_genkey_0=/order/**}}], filters=[], uri=lb://example-order-service, order=0}
